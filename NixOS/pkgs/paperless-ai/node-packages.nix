...
let
  sources = {
    ...
    "better-sqlite3-11.7.2" = {
      ...
      version = "11.7.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/better-sqlite3/-/better-sqlite3-11.7.2.tgz";
        sha512 = "10a57cHVDmfNQS4jrZ9AH2t+2ekzYh5Rhbcnb4ytpmYweoLdogDmyTt5D+hLiY9b44Mx9foowb/4iXBTO2yP3Q==";
      };
    };
    ...
    "openai-4.78.0" = {
      ...
      version = "4.78.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/openai/-/openai-4.78.0.tgz";
        sha512 = "4rRsKkx++5m1zayxkryVH+K/z91cv1sRbaNJAhSQjZiSCQOR7eaM8KpfIssXrS9Hlpta7+VcuO/fi57pW8xGjA==";
      };
    };
    "parseurl-1.3.3" = {
      name = "parseurl";
